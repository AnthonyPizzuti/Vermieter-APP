...
@Component({
  ...
  template: `
    <h2 mat-dialog-title>Mieter unwiderruflich löschen?</h2>
    <mat-dialog-content>
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-raised-button color="warn" (click)="check()">Löschen</button>
    </mat-dialog-actions>
  `
})
export class DeleteConfirm {
  ...
  constructor(public dialogRef: MatDialogRef<DeleteConfirm>) {}
